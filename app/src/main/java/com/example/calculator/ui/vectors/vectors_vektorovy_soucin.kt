...
class vectors_vektorovy_soucin : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.calculateButton.setOnClickListener { binding.result.text = computeVectorProduct() }

        return binding.root
    }

    private fun computeVectorProduct(): String {
